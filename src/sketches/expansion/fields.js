...
export const FIELD_PATTERNS = [
  ...
  expansionEntry({ id: 'vhs-head-switch', name: 'VHS Head Switch', group: 'Glitch / Effects', factory: vhsTracking, params: expansionParams('Signal Detail'), description: 'VHS head-switching and tracking errors over a synthesized broadcast signal: bass tears horizontal bands across the frame, mids restructure band count and wobble curvature, highs reseed dropouts, grain and chroma bleed.' }),
