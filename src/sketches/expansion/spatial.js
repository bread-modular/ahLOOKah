...
export const SPATIAL_PATTERNS = [
  ...
  expansionEntry({ id: 'techno-helix', name: 'Techno Helix', group: '3D', factory: technoHelix, params: expansionParams('Strand Detail'), description: 'Techno 3D descendant — wireframe double helix in flight: bass expands radius and dolly push, mids change twist density and skew rungs, highs spark rung midpoints and cross-links.' }),
